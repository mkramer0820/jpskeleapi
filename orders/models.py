...
class Orders(models.Model):
    buyer = models.ForeignKey('customer.Customer', "Buyer", verbose_name='Buyer', blank=True)
    ...
    factory = models.ForeignKey("factory.Factory", "Factory", verbose_name='Factory', blank=True, max_length=100)
    ...
    buyers_price = models.DecimalField(max_digits=max_dig, verbose_name='Price Buyer Paid', decimal_places=2,
                                       blank=True)
    order_type = models.CharField(choices=(('Delivary Duty Paid', 'DDP'),
                                           ('Freight On Board', 'FOB')), max_length=max_len,
